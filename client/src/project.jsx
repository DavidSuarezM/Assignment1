    ...
    return (
        <>
            <main>
                <h2>💼 My Projects</h2>
                <div>
                    <img src="Project1.png" alt="Fan Page" height="200" width="400"></img>
                ...
                <div>
                    <img src="Project2.png" alt="Streaming Site" height="200" width="400"></img>
                ...
                <div>
                    <img src="Project3.png" alt="Pokedex" height="200" width="400"></img>
