    ...
    return (
        <>
            <main>
                <h2>💼 My Projects</h2>
                <div>
                    <img src="Project1.png" class="projectPhoto" alt="Fan Page" height="200" width="400"></img>
                ...
                <div>
                    <img src="Project2.png" class="projectPhoto" alt="Streaming Site" height="200" width="400"></img>
                ...
                <div>
                    <img src="Project3.png" class="projectPhoto" alt="Pokedex" height="200" width="400"></img>
